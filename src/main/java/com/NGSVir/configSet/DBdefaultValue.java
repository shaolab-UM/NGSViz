package com.NGSVir.configSet;

import com.NGSVir.sqldbOperate.QueryDefaultDB;
...
public class DBdefaultValue extends InputParameterAttributes {
    public static void getPointLabFIValue(){
        ...
        String pointLab_value = QueryDefaultDB.getDefaultDBValue(query_key, genome, DB_tpye, region_type);
