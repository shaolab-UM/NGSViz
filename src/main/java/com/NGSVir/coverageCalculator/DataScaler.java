...
public class DataScaler {
    ...
    public static List<Double> getCoverageScaled(ArrayList<Integer> physical_coverage, String method, int flank_size) {
    ...
    // Output:
    //   coverage_scaled: List<Double> of binned values
    public static List<Double> bin(ArrayList<Integer> coverage_list, int num_points){
    ...
    // Output:
    //   coverage_scaled: List<Double> of binned values
    public static List<Double> spline(ArrayList<Integer> coverage_list , int num_points) {
        List<Double> coverage_scaled = new ArrayList<>();
