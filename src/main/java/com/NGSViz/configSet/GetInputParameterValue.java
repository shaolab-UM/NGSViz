...
public class GetInputParameterValue extends InputParameterAttributes {
    ...
    public static void getInputParametersValue (String[] args) {
        for (int i = 0; i < args.length; i = i + 2) {
            ...
            // Gene chunk size
            BATCH_SIZE = setParameterValue(BATCH_SIZE,"-BS", args, i);
    ...
    public static boolean setParameterValue(boolean var_name, String parameter, String [] args, int index){
        String res_out = getParameterValue(parameter, args, index);
        if (res_out != null) {var_name = Boolean.parseBoolean(res_out);}
        return var_name;
    }
