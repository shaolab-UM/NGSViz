...
public class ProcessEachQueryCoorRecord {
    ...
    public static EachCoverageResult processRecord2(Transcript gene_coord, SamReader bam_reader,
        ...
        double[] coverage_scaled = DataScaler.getCoverageScaled2(physical_coverage, scaler_method, flank_size);
    ...
    public static double[] processRecord(Map<String, Object> queryDB_record, String bam_file_path,
                                             String chr_name, boolean paired_mode) {
